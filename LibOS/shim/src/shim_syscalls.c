...
SHIM_SYSCALL_RETURN_ENOSYS(process_vm_readv, long, pid_t, pid, const struct iovec*, lvec,
                           unsigned long, liovcnt, const struct iovec*, rvec, unsigned long,
                           riovcnt, unsigned long, flags);
SHIM_SYSCALL_RETURN_ENOSYS(process_vm_writev, long, pid_t, pid, const struct iovec*, lvec,
                           unsigned long, liovcnt, const struct iovec*, rvec,
                           unsigned long, riovcnt, unsigned long, flags)
SHIM_SYSCALL_RETURN_ENOSYS(kcmp, long, pid_t, pid1, pid_t, pid2, int, type,
    unsigned long, idx1, unsigned long, idx2)
SHIM_SYSCALL_RETURN_ENOSYS(finit_module, long, int, fd, const char*, uargs, int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(sched_setattr, long, pid_t, pid, struct sched_attr*, uattr,
             unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(sched_getattr, long, pid_t, pid, struct sched_attr*, uattr,
    unsigned int, usize, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(renameat2, long, int, olddfd, const char*, oldname,
    int, newdfd, const char*, newname, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(seccomp, long, unsigned int, op, unsigned int, flags,
       void*, uargs)
SHIM_SYSCALL_RETURN_ENOSYS(getrandom, long, char*, buf, size_t, count,
    unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(memfd_create, long, const char*, uname,
    unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(kexec_file_load, long, int, kernel_fd, int, initrd_fd,
    unsigned long, cmdline_len, const char*, cmdline_ptr,
    unsigned long, flags)
SHIM_SYSCALL_RETURN_ENOSYS(bpf, long, int, cmd, union bpf_attr*, uattr, unsigned int, size)
SHIM_SYSCALL_RETURN_ENOSYS(execveat, long, int, fd, const char*, filename,
    const char*const*, argv,
    const char*const*, envp,
    int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(userfaultfd, long, int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(membarrier, long, int, cmd, int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(mlock2, long, unsigned long, start, size_t, len, int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(copy_file_range, long, int, fd_in, loff_t*, off_in,
    int, fd_out, loff_t*, off_out,
    size_t, len, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(preadv2, long, unsigned long, fd, const struct iovec*, vec,
    unsigned long, vlen, unsigned long, pos_l, unsigned long, pos_h,
    rwf_t, flags)
SHIM_SYSCALL_RETURN_ENOSYS(pwritev2, long, unsigned long, fd, const struct iovec*, vec,
    unsigned long, vlen, unsigned long, pos_l, unsigned long, pos_h,
    rwf_t, flags)
SHIM_SYSCALL_RETURN_ENOSYS(pkey_mprotect, long, unsigned long, start, size_t, len,
    unsigned long, prot, int, pkey)
SHIM_SYSCALL_RETURN_ENOSYS(pkey_alloc, long, unsigned long, flags, unsigned long, init_val)
SHIM_SYSCALL_RETURN_ENOSYS(pkey_free, long, int, pkey)
SHIM_SYSCALL_RETURN_ENOSYS(statx, long, int, dfd, const char*, filename, unsigned, flags,
    unsigned int, mask,
    struct statx*, buffer)
SHIM_SYSCALL_RETURN_ENOSYS(io_pgetevents, long, aio_context_t, ctx_id,
    long, min_nr,
    long, nr,
    struct io_event*, events,
    struct __kernel_timespec*, timeout,
    const struct __aio_sigset*, usig)
SHIM_SYSCALL_RETURN_ENOSYS(rseq, long, struct rseq*, rseq, u32, rseq_len,
    int, flags, u32, sig)
SHIM_SYSCALL_RETURN_ENOSYS(pidfd_send_signal, long, int, pidfd, int, sig,
    siginfo_t*, info, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(io_uring_setup, long, u32, entries,
    struct io_uring_params*, params)
SHIM_SYSCALL_RETURN_ENOSYS(io_uring_enter, long, unsigned int, fd, u32, to_submit,
    u32, min_complete, u32, flags, const sigset_t*, sig,
    size_t, sigsz)
SHIM_SYSCALL_RETURN_ENOSYS(io_uring_register, long, unsigned int, fd, unsigned int, opcode,
