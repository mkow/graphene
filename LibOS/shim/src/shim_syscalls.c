...
SHIM_SYSCALL_RETURN_ENOSYS(kcmp, 5, long, pid_t, pid1, pid_t, pid2, int, type,
...
SHIM_SYSCALL_RETURN_ENOSYS(renameat2, 5, long, int, olddfd, const char*, oldname,
    int, newdfd, const char*, newname, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(seccomp, 3, long, unsigned int, op, unsigned int, flags,
       void*, uargs)
SHIM_SYSCALL_RETURN_ENOSYS(getrandom, 3, long, char*, buf, size_t, count,
    unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(memfd_create, 2, long, const char*, uname,
    unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(kexec_file_load, 5, long, int, kernel_fd, int, initrd_fd,
    unsigned long, cmdline_len, const char*, cmdline_ptr,
    unsigned long, flags)
SHIM_SYSCALL_RETURN_ENOSYS(bpf, 3, long, int, cmd, union bpf_attr*, uattr, unsigned int, size)
SHIM_SYSCALL_RETURN_ENOSYS(execveat, 5, long, int, fd, const char*, filename,
...
SHIM_SYSCALL_RETURN_ENOSYS(copy_file_range, 6, long, int, fd_in, loff_t*, off_in,
...
SHIM_SYSCALL_RETURN_ENOSYS(pwritev2, 6, long, unsigned long, fd, const struct iovec*, vec,
    unsigned long, vlen, unsigned long, pos_l, unsigned long, pos_h,
    rwf_t, flags)
SHIM_SYSCALL_RETURN_ENOSYS(pkey_mprotect, 4, long, unsigned long, start, size_t, len,
...
SHIM_SYSCALL_RETURN_ENOSYS(statx, 5, long, int, dfd, const char*, filename, unsigned, flags,
    unsigned int, mask,
    struct statx*, buffer)
SHIM_SYSCALL_RETURN_ENOSYS(io_pgetevents, 6, long, aio_context_t, ctx_id,
    long, min_nr,
    long, nr,
    struct io_event*, events,
    struct __kernel_timespec*, timeout,
    const struct __aio_sigset*, usig)
SHIM_SYSCALL_RETURN_ENOSYS(rseq, 4, long, struct rseq*, rseq, u32, rseq_len,
    int, flags, u32, sig)
SHIM_SYSCALL_RETURN_ENOSYS(pidfd_send_signal, 4, long, int, pidfd, int, sig,
    siginfo_t*, info, unsigned int, flags)
SHIM_SYSCALL_RETURN_ENOSYS(io_uring_setup, 2, long, u32, entries,
    struct io_uring_params*, params)
SHIM_SYSCALL_RETURN_ENOSYS(io_uring_enter, 6, long, unsigned int, fd, u32, to_submit,
